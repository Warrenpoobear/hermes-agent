...
from agent.process_bootstrap import (  # noqa: F401
...
from model_tools import (  # noqa: F401
...
from agent.codex_responses_adapter import (  # noqa: F401
    ...
    def _hook_jsonable(
        ...
        *,
        ...
        try:
            ...
            pass
        if isinstance(value, SimpleNamespace):  # noqa: F821
            return cls._hook_jsonable(
                vars(value),
                depth=depth + 1,
                max_depth=max_depth,
